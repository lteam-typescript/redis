...
exports.redis = redis;
function createClientWithOption(options) {
    const oldRedisClient = redis.createClient(options);
    return bb.promisifyAll(oldRedisClient); // cast
}
exports.createClientWithOption = createClientWithOption;
function createClient(port = 6379, host = "127.0.0.1", MAX_ATTEMPT = -1, MAX_RETRY_TIME_IN_MILLIS = -1, QUIT_IF_ECONNREFUSED = false) {
